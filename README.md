...
[![GitHub Repository](https://img.shields.io/badge/GitHub-Repository-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/ZEKT-VII/DecodeLabs-Internship)
[![Tests Passing](https://img.shields.io/badge/Tests-125_Passing-brightgreen?style=for-the-badge&logo=pytest&logoColor=white)](https://github.com/ZEKT-VII/DecodeLabs-Internship)
...
### 1. Installation
```bash
git clone https://github.com/ZEKT-VII/DecodeLabs-Internship.git
...
1. Click **Code** ➔ **Codespaces** ➔ **Create codespace on main** on the [GitHub Repository](https://github.com/ZEKT-VII/DecodeLabs-Internship).
...
2. Click **New** ➔ **Web Service** ➔ Select your GitHub repo `ZEKT-VII/DecodeLabs-Internship`.
...
```bash
# Build Docker image
docker build -t decodelabs-internship .

# Run container on port 8000
docker run -p 8000:8000 decodelabs-internship
```
